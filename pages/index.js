                    ...
                    {sections.map((section, i) => {
                        return (
                            <Link
                                ...
                                className={`nav-item mx-auto flex h-6 w-6 cursor-pointer items-center justify-center border-b shadow-lg md:h-12 md:w-12 ${
                                    i + 1 === sections.length
                            ...
                            >
                                <span
                                    className={`material-icons block text-center text-sm md:text-3xl ${
                                        i + 1 === sections.length
                                            ? "text-green-300"
                                            : "text-blue-300"
                                    }`}
